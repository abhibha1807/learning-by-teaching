...
#default='/abhibha-volume/Image-Enhancer/'
#default='/Users/abhibhagupta/Desktop/ucsd/smrt-master/'
#'/Users/abhibhagupta/Desktop/ucsd/lbt/data/'
parser.add_argument('--data', type=str,default='/Users/abhibhagupta/Desktop/ucsd/smrt-master/dataset/' , help='location of the data corpus')
...
def main():
  ...
  total_data=data['train']
  print('total data:', len(total_data))
  
  # valid_data=total_data[n:n+854]
  # train_data=total_data[0:n]+total_data[n+854:]
  ...
  #   print(i[0].shape)
  #   break
  num_train = len(total_data)
  indices = list(range(num_train))
  split = int(np.floor(0.1 * num_train))
  n=random.randint(0, num_train-split)

  train_queue = torch.utils.data.DataLoader(total_data, batch_size=args.batch_size,
          sampler=torch.utils.data.sampler.SubsetRandomSampler(indices[:n]+indices[n+split:]),
          pin_memory=True, num_workers=2)

  valid_queue = torch.utils.data.DataLoader(total_data, batch_size=args.batch_size,
        sampler=torch.utils.data.sampler.SubsetRandomSampler(indices[n:n+split]),
        pin_memory=True, num_workers=2)
